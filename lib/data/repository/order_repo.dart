...
class OrderRepo extends GetxService {
  ...
  Future<Response> getOrderDetails(int orderID,[bool isNeedToSetOrderModel=false]) {
    print("isNeedToSetOrderModel :-> $isNeedToSetOrderModel");
    return apiClient.getData('${AppConstants.ORDER_DETAILS_URI}${getUserToken()}&order_id=$orderID${isNeedToSetOrderModel?"&is_info=$isNeedToSetOrderModel":""}');
  }
