class ConfigModel {
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    print("json['app_minimum_version_android_rider'] :-> ${json['app_minimum_version_android_rider']}");
    print("json['app_url_android_rider'] :-> ${json['app_url_android_rider']}");
    ...
    appUrlAndroid = json['app_url_android_rider'];
    appUrlIos = json['app_url_ios_rider'];
    appMinimumVersionAndroid = json['app_minimum_version_android_rider'];
    appMinimumVersionIos = json['app_minimum_version_ios_rider'];
