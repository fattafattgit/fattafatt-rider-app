...
import 'package:fattafatt_rider/view/screens/OrderChat/order_chat.dart';
import 'package:fattafatt_rider/view/screens/auth/sign_in_screen.dart';
import 'package:fattafatt_rider/view/screens/dashboard/dashboard_screen.dart';
import 'package:fattafatt_rider/view/screens/forget/forget_pass_screen.dart';
import 'package:fattafatt_rider/view/screens/forget/new_pass_screen.dart';
import 'package:fattafatt_rider/view/screens/forget/verification_screen.dart';
import 'package:fattafatt_rider/view/screens/html/html_viewer_screen.dart';
import 'package:fattafatt_rider/view/screens/language/language_screen.dart';
import 'package:fattafatt_rider/view/screens/notification/notification_screen.dart';
import 'package:fattafatt_rider/view/screens/order/order_details_screen.dart';
import 'package:fattafatt_rider/view/screens/order/running_order_screen.dart';
import 'package:fattafatt_rider/view/screens/profile/update_profile_screen.dart';
import 'package:fattafatt_rider/view/screens/splash/splash_screen.dart';
import 'package:fattafatt_rider/view/screens/update/update_screen.dart';
...
class RouteHelper {
  ...
  static String getOrderDetailsRoute(int id,[String isFromNotification='']) => '$orderDetails?id=$id&isFromNotification=$isFromNotification';
  ...
  static String getOrderChatRoute(int orderId,String chatType) => '$orderChat?orderId=$orderId&chatType=$chatType';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: orderDetails, page: () {
      print("_orderID_orderID_orderID:->> ${Get.parameters['id']}");
      OrderDetailsScreen _orderDetails = Get.arguments;
      return _orderDetails != null ? _orderDetails : OrderDetailsScreen(
        orderModel: OrderModel(id: int.parse(Get.parameters['id'])), orderIndex: null, isRunningOrder: false, isFromNotification: Get.parameters['isFromNotification'],
      );
    }),
    ...
    GetPage(name: orderChat, page: () {
      print("Get.parameters:-> ${Get.parameters}");
      return OrderChat(orderId: int.parse(Get.parameters['orderId']),chatType: Get.parameters['chatType']=='normal_chat'?ChatType.CUSTOMER:ChatType.SUPPORT,);
    }),
  ];
