...
import 'package:fattafatt_rider/view/base/custom_text_field.dart';
import 'package:fattafatt_rider/view/screens/auth/widget/code_picker_widget.dart';
...
class _ForgetPassScreenState extends State<ForgetPassScreen> {
  ...
  String _countryDialCode = "+92"; //CountryCode.fromCountryCode(Get.find<SplashController>().configModel.country).dialCode;
