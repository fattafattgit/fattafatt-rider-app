...
import 'package:fattafatt_rider/view/base/custom_alert_dialog.dart';
import 'package:fattafatt_rider/view/screens/dashboard/widget/bottom_nav_item.dart';
import 'package:fattafatt_rider/view/screens/dashboard/widget/new_request_dialog.dart';
import 'package:fattafatt_rider/view/screens/home/home_screen.dart';
import 'package:fattafatt_rider/view/screens/profile/profile_screen.dart';
import 'package:fattafatt_rider/view/screens/request/order_request_screen.dart';
import 'package:fattafatt_rider/view/screens/order/order_screen.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      if(_type == 'new_order'||_type == 'order_request') {
        ...
        Get.dialog(NewRequestDialog(isRequest: true, onTap: (){
          _navigateRequestPage(_orderID.isNotEmpty?int.parse(_orderID):-1);
        })).then((value){
  ...
  void _navigateRequestPage([int _orderID=-1]) {
    if(Get.find<AuthController>().profileModel != null && Get.find<AuthController>().profileModel.active == 1
      ...
      if(_orderID!=-1){
        ...
        Get.toNamed(
          RouteHelper.getOrderDetailsRoute(_orderID,'Yes'),
        );
      }
    }else {
