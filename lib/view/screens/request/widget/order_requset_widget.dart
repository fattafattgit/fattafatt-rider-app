...
import 'package:fattafatt_rider/helper/date_converter.dart';
                    ...
                    if(isSuccess) {
                      ...
                      Get.toNamed(
                        ...
                        arguments: OrderDetailsScreen(
                          orderModel: orderModel, isRunningOrder: true, orderIndex: orderController.currentOrderList.length-1,isFromNotification: '',
                        ),
                      );
                    }else {
